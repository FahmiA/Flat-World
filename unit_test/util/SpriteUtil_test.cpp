...
TEST_F(SpriteUtilTest, rayTraceCommonCase)
{
    ...
    Vector2f *result = spriteUtil->rayTrace(image, 18, 10, 12, 10);
    ...
    result = spriteUtil->rayTrace(image, 14, 0, 14, 14);
    ...
    result = spriteUtil->rayTrace(image, 15, 4, 14, 6);
...
TEST_F(SpriteUtilTest, rayTraceInvertedCase)
{
    ...
    result = spriteUtil->rayTrace(image, 12, 10, 18, 10, false);
    ...
    result = spriteUtil->rayTrace(image, 14, 14, 14, 0, false);
    ...
    result = spriteUtil->rayTrace(image, 14, 6, 15, 4, false);
