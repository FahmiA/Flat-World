 ...
 * For SFML.
 * Source: https://github.com/LaurentGomila/SFML/wiki/SourceSimpleCollisionDetection
 * Updated to SFML v2 by: Fahmi Abdulhamid
...
private:
    ...
    static sf::Vector2f& getSize(const sf::Sprite& Object);
};
