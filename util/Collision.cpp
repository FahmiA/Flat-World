...
/*bool Collision::PixelPerfectTest(const sf::Sprite& Object1, const sf::Sprite& Object2, sf::Uint8 AlphaLimit) {
    ...
    if (Object1AABB.intersects(Object2AABB, Intersection)) {
        ...
        sf::Transform Object1LocalTransform = Object1.getInverseTransform();
        sf::Transform Object2LocalTransform = Object2.getInverseTransform();

        //Loop through our pixels
        for (int i = Intersection.left; i < (Intersection.left+Intersection.width); i++) {
            for (int j = Intersection.top; j < (Intersection.top+Intersection.height); j++) {

                o1v = Object1LocalTransform.transformPoint(sf::Vector2f(i, j)); //Creating Objects each loop :(
                o2v = Object2LocalTransform.transformPoint(sf::Vector2f(i, j));
...
bool Collision::CircleTest(const sf::Sprite& Object1, const sf::Sprite& Object2) {
    ...
    float Radius1 = (getSize(Object1).x + getSize(Object1).y) / 4;
    float Radius2 = (getSize(Object2).x + getSize(Object2).y) / 4;
...
sf::Vector2f& Collision::getSize(const sf::Sprite& Object)
{
    sf::IntRect textureSize = Object.getTextureRect();
    sf::Vector2f scale = Object.getScale();

    sf::Vector2f *size = new sf::Vector2f(textureSize.width * scale.x, textureSize.height * scale.y);
    return *size;
}
